...
| 5 | Pytest + Requests | 5/9 | **第 5 课进行中** |
| 6 | Selenium | 0/— | 未开始 |
| 7 | JMeter | 0/— | 未开始 |
| 8 | MeterSphere | 0/— | 未开始 |
| 9 | Jenkins | 0/— | 未开始 |
...
| 08 | 下单 / 取消 / 状态机 / 重复取消 | [~] 进行中（练习 1-5 完成） |
| 09 | Collection Runner 串联整条业务流 | [ ] 未开始 |
| 10 | 整理集合命名 + 导出备份（简历素材） | [ ] 未开始 |
...
- [x] 订单创建/取消/支付、状态机、重复取消 409
- [ ] Collection Runner 串联
- [ ] 集合导出与简历整理
...
| 04 | 函数与异常 | [ ] 未开始 |
| 05 | JSON、模块、文件 | [ ] 未开始 |
| 06 | requests 发 HTTP 请求 | [~] 与 Pytest 第 1 课合并 |
